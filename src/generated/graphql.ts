...
export type AddCartItemMutation = { __typename?: 'Mutation', checkoutLineItemsAdd?: { __typename?: 'CheckoutLineItemsAddPayload', checkout?: { __typename?: 'Checkout', webUrl: any, id: string } | null } | null };
...
export type GetShopInfoQuery = { __typename?: 'QueryRoot', shop: { __typename?: 'Shop', name: string, description?: string | null, shippingPolicy?: { __typename?: 'ShopPolicy', title: string, url: any, body: string } | null, refundPolicy?: { __typename?: 'ShopPolicy', body: string } | null, primaryDomain: { __typename?: 'Domain', url: any } } };
...
export const GetCartItemCountDocument = `
  ...
  node(id: $checkoutId) {
    ...
    `;
export const useGetCartItemCountQuery = <
      TData = GetCartItemCountQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetCartItemCountQueryVariables,
      options?: UseQueryOptions<GetCartItemCountQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetCartItemCountQuery, TError, TData>(
      ['getCartItemCount', variables],
      fetcher<GetCartItemCountQuery, GetCartItemCountQueryVariables>(client, GetCartItemCountDocument, variables, headers),
      options
    );

useGetCartItemCountQuery.getKey = (variables: GetCartItemCountQueryVariables) => ['getCartItemCount', variables];
;

export const useInfiniteGetCartItemCountQuery = <
      TData = GetCartItemCountQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetCartItemCountQueryVariables,
      client: GraphQLClient,
      variables: GetCartItemCountQueryVariables,
      options?: UseInfiniteQueryOptions<GetCartItemCountQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetCartItemCountQuery, TError, TData>(
      ['getCartItemCount.infinite', variables],
      (metaData) => fetcher<GetCartItemCountQuery, GetCartItemCountQueryVariables>(client, GetCartItemCountDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );


useInfiniteGetCartItemCountQuery.getKey = (variables: GetCartItemCountQueryVariables) => ['getCartItemCount.infinite', variables];
;

useGetCartItemCountQuery.fetcher = (client: GraphQLClient, variables: GetCartItemCountQueryVariables, headers?: RequestInit['headers']) => fetcher<GetCartItemCountQuery, GetCartItemCountQueryVariables>(client, GetCartItemCountDocument, variables, headers);
...
useCreateCartMutation.getKey = () => ['createCart'];
...
useAddCartItemMutation.getKey = () => ['addCartItem'];
...
export const useUpdateCartItemMutation = <
    ...
    useMutation<UpdateCartItemMutation, TError, UpdateCartItemMutationVariables, TContext>(
      ['updateCartItem'],
      (variables?: UpdateCartItemMutationVariables) => fetcher<UpdateCartItemMutation, UpdateCartItemMutationVariables>(client, UpdateCartItemDocument, variables, headers)(),
      options
    );
useUpdateCartItemMutation.getKey = () => ['updateCartItem'];

useUpdateCartItemMutation.fetcher = (client: GraphQLClient, variables: UpdateCartItemMutationVariables, headers?: RequestInit['headers']) => fetcher<UpdateCartItemMutation, UpdateCartItemMutationVariables>(client, UpdateCartItemDocument, variables, headers);
...
useRemoveCartItemMutation.getKey = () => ['removeCartItem'];
...
export const useGetProductBySlugQuery = <
    ...
    >(
      ...
      options?: UseQueryOptions<GetProductBySlugQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetProductBySlugQuery, TError, TData>(
      ['GetProductBySlug', variables],
      fetcher<GetProductBySlugQuery, GetProductBySlugQueryVariables>(client, GetProductBySlugDocument, variables, headers),
      options
    );

useGetProductBySlugQuery.getKey = (variables: GetProductBySlugQueryVariables) => ['GetProductBySlug', variables];
;

export const useInfiniteGetProductBySlugQuery = <
      TData = GetProductBySlugQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetProductBySlugQueryVariables,
      client: GraphQLClient,
      variables: GetProductBySlugQueryVariables,
      options?: UseInfiniteQueryOptions<GetProductBySlugQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetProductBySlugQuery, TError, TData>(
      ['GetProductBySlug.infinite', variables],
      (metaData) => fetcher<GetProductBySlugQuery, GetProductBySlugQueryVariables>(client, GetProductBySlugDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );


useInfiniteGetProductBySlugQuery.getKey = (variables: GetProductBySlugQueryVariables) => ['GetProductBySlug.infinite', variables];
;
...
export const GetShopInfoDocument = `
  ...
  shop {
    ...
    `;
export const useGetShopInfoQuery = <
      TData = GetShopInfoQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetShopInfoQueryVariables,
      options?: UseQueryOptions<GetShopInfoQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetShopInfoQuery, TError, TData>(
      variables === undefined ? ['GetShopInfo'] : ['GetShopInfo', variables],
      fetcher<GetShopInfoQuery, GetShopInfoQueryVariables>(client, GetShopInfoDocument, variables, headers),
      options
    );

useGetShopInfoQuery.getKey = (variables?: GetShopInfoQueryVariables) => variables === undefined ? ['GetShopInfo'] : ['GetShopInfo', variables];
;

export const useInfiniteGetShopInfoQuery = <
      TData = GetShopInfoQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetShopInfoQueryVariables,
      client: GraphQLClient,
      variables?: GetShopInfoQueryVariables,
      options?: UseInfiniteQueryOptions<GetShopInfoQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetShopInfoQuery, TError, TData>(
      variables === undefined ? ['GetShopInfo.infinite'] : ['GetShopInfo.infinite', variables],
      (metaData) => fetcher<GetShopInfoQuery, GetShopInfoQueryVariables>(client, GetShopInfoDocument, {...variables, ...(metaData.pageParam ?? {})}, headers)(),
      options
    );


useInfiniteGetShopInfoQuery.getKey = (variables?: GetShopInfoQueryVariables) => variables === undefined ? ['GetShopInfo.infinite'] : ['GetShopInfo.infinite', variables];
;

useGetShopInfoQuery.fetcher = (client: GraphQLClient, variables?: GetShopInfoQueryVariables, headers?: RequestInit['headers']) => fetcher<GetShopInfoQuery, GetShopInfoQueryVariables>(client, GetShopInfoDocument, variables, headers);