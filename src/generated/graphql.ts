...
export type CreateCartMutation = {
  ...
  checkoutCreate?: {
    __typename?: "CheckoutCreatePayload";
    checkout?: { __typename?: "Checkout"; id: string; webUrl: any } | null;
  } | null;
};
...
export type GetShopInfoQuery = {
  ...
  shop: {
    ...
    refundPolicy?: { __typename?: "ShopPolicy"; body: string } | null;
    primaryDomain: { __typename?: "Domain"; url: any };
  };
};
...
>(
  ...
  useQuery<GetCartItemCountQuery, TError, TData>(
    ...
    fetcher<GetCartItemCountQuery, GetCartItemCountQueryVariables>(
      client,
...
useInfiniteGetCartItemCountQuery.getKey = (
  variables: GetCartItemCountQueryVariables
) => ["getCartItemCount.infinite", variables];
useGetCartItemCountQuery.fetcher = (
  client: GraphQLClient,
  variables: GetCartItemCountQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
export const AddCartItemDocument = `
  ...
  checkoutLineItemsAdd(checkoutId: $checkoutId, lineItems: [$lineItem]) {
    ...
    `;
export const useAddCartItemMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    AddCartItemMutation,
    TError,
  ...
  >(
    ...
    (variables?: AddCartItemMutationVariables) =>
      fetcher<AddCartItemMutation, AddCartItemMutationVariables>(
        client,
        AddCartItemDocument,
        variables,
        headers
...
useAddCartItemMutation.fetcher = (
  client: GraphQLClient,
  variables: AddCartItemMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
export const useUpdateCartItemMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: UpdateCartItemMutationVariables) =>
      fetcher<UpdateCartItemMutation, UpdateCartItemMutationVariables>(
        client,
...
export const RemoveCartItemDocument = `
  ...
  checkoutLineItemsRemove(checkoutId: $checkoutId, lineItemIds: [$lineItemId]) {
    ...
    `;
export const useRemoveCartItemMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >(
    ...
    (variables?: RemoveCartItemMutationVariables) =>
      fetcher<RemoveCartItemMutation, RemoveCartItemMutationVariables>(
        client,
...
useRemoveCartItemMutation.fetcher = (
  client: GraphQLClient,
  variables: RemoveCartItemMutationVariables,
  headers?: RequestInit["headers"]
) =>
...
>(
  ...
  useQuery<GetProductBySlugQuery, TError, TData>(
    ...
    fetcher<GetProductBySlugQuery, GetProductBySlugQueryVariables>(
      client,
...
useGetProductBySlugQuery.getKey = (
  variables: GetProductBySlugQueryVariables
) => ["GetProductBySlug", variables];
...
useInfiniteGetProductBySlugQuery.getKey = (
  variables: GetProductBySlugQueryVariables
) => ["GetProductBySlug.infinite", variables];
useGetProductBySlugQuery.fetcher = (
  client: GraphQLClient,
  variables: GetProductBySlugQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
>(
  ...
  useInfiniteQuery<GetAllCollectionsQuery, TError, TData>(
    variables === undefined
      ? ["GetAllCollections.infinite"]
      : ["GetAllCollections.infinite", variables],
    (metaData) =>
      fetcher<GetAllCollectionsQuery, GetAllCollectionsQueryVariables>(
        client,
        GetAllCollectionsDocument,
...
useInfiniteGetAllCollectionsQuery.getKey = (
  variables?: GetAllCollectionsQueryVariables
) =>
  variables === undefined
    ? ["GetAllCollections.infinite"]
    : ["GetAllCollections.infinite", variables];
useGetAllCollectionsQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetAllCollectionsQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
useGetCollectionByHandleQuery.getKey = (
  variables: GetCollectionByHandleQueryVariables
) => ["GetCollectionByHandle", variables];
...
useGetCollectionByHandleQuery.fetcher = (
  client: GraphQLClient,
  variables: GetCollectionByHandleQueryVariables,
  headers?: RequestInit["headers"]
) =>
...
export const GetShopInfoDocument = `
  ...
  shop {
    ...
    `;
export const useGetShopInfoQuery = <TData = GetShopInfoQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<GetShopInfoQuery, TError, TData>(
    ...
    fetcher<GetShopInfoQuery, GetShopInfoQueryVariables>(
      client,
      GetShopInfoDocument,
      variables,
      headers
...
useGetShopInfoQuery.getKey = (variables?: GetShopInfoQueryVariables) =>
  variables === undefined ? ["GetShopInfo"] : ["GetShopInfo", variables];
...
>(
  ...
  useInfiniteQuery<GetShopInfoQuery, TError, TData>(
    variables === undefined
      ? ["GetShopInfo.infinite"]
      : ["GetShopInfo.infinite", variables],
    (metaData) =>
      fetcher<GetShopInfoQuery, GetShopInfoQueryVariables>(
        client,
        GetShopInfoDocument,
...
useInfiniteGetShopInfoQuery.getKey = (variables?: GetShopInfoQueryVariables) =>
  variables === undefined
    ? ["GetShopInfo.infinite"]
    : ["GetShopInfo.infinite", variables];
useGetShopInfoQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetShopInfoQueryVariables,
  headers?: RequestInit["headers"]
) =>
